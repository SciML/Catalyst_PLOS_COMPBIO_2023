...
#SBATCH -o ../Benchmarking_results/Threads_1/Logs/run_benchmarks_gillespy2_ssa.log
#SBATCH -N 1  
#SBATCH --ntasks=1  
...
time python3 gillespy2_make_benchmarks.py multistate ssa 1 5 9 10

echo "Starts benchmark runs on the multisite2 model."
time python3 gillespy2_make_benchmarks.py multisite2 ssa 1 4 7 10

echo "Starts benchmark runs on the egfr_net model."
time python3 gillespy2_make_benchmarks.py egfr_net ssa 1 2 4 10
...
time python3 gillespy2_make_benchmarks.py fceri_gamma2 ssa 1 2 4 5